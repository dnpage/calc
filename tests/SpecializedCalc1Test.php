...
class SpecializedCalc1Test extends \PHPUnit_Framework_TestCase
{
    /**
     * @param $data
     * @param $x
     ...
     */
    public function testSpecializedCalc1($data, $x, $y, $status)
    {
        $calc = new SpecializedCalc1($data);
        $results = $calc->run();
    ...
    public function inputProvider()
    {
        return [
            ...
            [['a' => true,  'b' => true,  'c' => true,  'd' => 2, 'e' => 3, 'f' => 4], 'r',  4.06, 'success']
        ];
    }
